...
/**
 * Allows HTTPRules to be generated from a .yml file instead of the .proto files. Any rule defined in a .yml file will
 * override rules in the .proto. https://cloud.google.com/endpoints/docs/grpc-service-config
 *
